  ...
  return (
    <div className="flex ">
      <div className=" flex space-x-4 mx-4 items-center">
        <div className="p-4 hover:bg-slate-200 transition-colors duration-300 hover:cursor-pointer size-16 flex items-center justify-center rounded-lg">
      ...
      <div
        ...
        className="p-4 hover:bg-yellow-200 transition-colors duration-300 hover:cursor-pointer size-20 flex items-center justify-center rounded-full bg-yellow-400 mr-4"
      >
